      ...
      <div className="flex flex-col w-[345px] items-start px-0 py-6 relative left-[41px]">
        <div className="flex flex-col w-[345px] items-start gap-[15px] relative flex-[0_0_auto]">
          <div className="relative w-[345px] h-[556px]">
            <div className="h-[556px] bg-white overflow-hidden">
              <div className="relative w-[346px] h-[556px] -left-px">
                <div className="absolute w-[345px] h-[556px] top-0 left-px bg-[url(E:/GitHub/E-Commerce-Project/src/icons/unsplash_p0j-mE6mGo4.jpg)] bg-cover bg-[50%_50%]" />
          ...
          <div className="relative w-[344px] h-[398px]">
            <div className="h-[398px] bg-white overflow-hidden">
              <div className="relative w-[346px] h-[398px] -left-px">
                <div className="absolute w-[344px] h-[398px] top-0 left-px bg-[url(E:/GitHub/E-Commerce-Project/src/icons/unsplash_Bd7gNnWJBkU.jpg)] bg-cover bg-[50%_50%]" />
          ...
          <div className="relative w-[344px] h-[398px]">
            <div className="h-[398px] bg-white overflow-hidden">
              <div className="relative w-[346px] h-[398px] -left-px">
                <div className="absolute w-[344px] h-[398px] top-0 left-px bg-[url(E:/GitHub/E-Commerce-Project/src/icons/shopCardLastPic.jpg)] bg-cover bg-[50%_50%]" />
